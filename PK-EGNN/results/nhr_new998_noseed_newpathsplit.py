...
val_paths, train_paths = all_paths[30:300] + all_paths[310:1000], all_paths[20:30] + all_paths[300:310] 
print(train_paths)
...
torch.save(checkpoint, f"./1000inputs_{runid}-checkpoint_{timestamp}.pt")
