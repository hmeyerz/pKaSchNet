...
def get_neighborhood(
    ...
    # Eliminate true self interaction / self-edges that don't cross periodic boundaries
    ...
    return np.stack((sender, receiver)), np.dot(unit_shifts, cell), unit_shifts[keep_edge], cell
