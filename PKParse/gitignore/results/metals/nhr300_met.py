...
to=time.time()
#files  = 100
ps=glob.glob("./inputs_pkegnn/*.npz")
np.random.shuffle(ps)
paths  = ps[0:100] #+ glob.glob("./inputs2/*.npz")[300:500] + glob.glob("./inputs2/*.npz")[1500:2700]# + glob.glob("./inputs2/*.npz")[120:]
tpaths = ps[100:] #+ glob.glob("./inputs2/*.npz")[1300:1500] #+ glob.glob("./inputs2/*.npz")[2700:2800] 
batch_size=5
...
dim, basis = 4, 32 #scale to 3,16 at least # dim must be divisible by 2
